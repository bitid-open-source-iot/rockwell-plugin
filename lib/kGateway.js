...
class kGateway{
    ...
    init(){
        ...
        // self.mqtt_biTidServer.mqtt.on('connect', () => {
        //     __logger.info('Connecting to mqtt_biTidServer: Success');
        // })
        ...
        //     if(self.mqtt_biTidServer.mqtt.connected != true){
        //         self.mqtt_biTidServer.connect(__settings.mqttServerBitid)
        //     }
        //     if(self.mqtt_Routers.mqtt.connected != true){
        //         self.mqtt_Routers.connect(__settings.mqttRouters)
        //     }
        // },60000)
    ...
    processData(args) {
        ...
        try {
            ...
            if (typeof (lastTag) == 'undefined') {
                 ...
                 */
                if ((time - lastTag.time > (self.tagFixedTxTime * 1000 * 60)) || lastTag.bitidDeviceId != args.bitidDeviceId) {
                    ...
                    lastTag.bitidDeviceId = args.bitidDeviceId
                    lastTag.txCount++
                    self.mqtt_biTidServer.send('/kGateway/edge/data', {"marker":"shane",topic,message})
                } else {
